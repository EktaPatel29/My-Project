	...
	app.controller('CategoryFormSubmitController',[ '$scope', '$http', function($scope, $http) {
		...
		$scope.list = [];
			...
			{	
				...
				var response = $http.post('createCat',cat);
			...
			$scope.deleteCategoryById=function(categoryId)
			{
...
>>>>>>> 5f3e86f59d40084b87dc8af3edba3bab73e30aee
...
<body>
	...
	<form data-ng-submit="submit()"
		data-ng-controller="CategoryFormSubmitController">
		<h3>{{heading}}</h3>


		<p>
			Category Name: <input type="text"
				data-ng-model="category.categoryName">
		</p>
				...
				<tbody>
					<tr ng-repeat="u in listOfcategory">
						...
						<td>
							...
							<button type="button" ng-click="editCategory(u.categoryId)"
								class="btn btn-success custom-width">Edit</button>
							<button type="button" ng-click="deleteCategoryById(u.categoryId)"
